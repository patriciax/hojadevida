...
function goToRoute() {
  const url = `${newUrl.value}${resumenStore.data.code_url}`
...
<template>
  <div class="settings">
    <div class="flex justify-center items-center title pt-2 px-6 bg-white  py-3 sticky top-0 z-50">
      <LandingLogo @toggle-sidebar="isOpen = !isOpen">
        <!-- <button
          class=" hidden gap-2 text-sm md:hidden text-gray-700 hover:bg-gray-200 justify-center items-center border border-gray-300 px-2 py-1.5 rounded-lg"
        ...
        <expansion-panel :panel-name="$t('personal-details')">
          ...
          <template #content>
            <div class="grid grid-cols-2 gap-x-2 gap-y-4">
              ...
              <div v-if="!resumenStore.isShowCarta" class="form__group col-span-full relative  ">
                <label
              ...
              <div class="grid grid-cols-2 gap-x-3 gap-y-10">
                ...
                <div class="form__group col-span-full">
                  ...
                  >
                    ...
                    <svg class="w-6 h-6 mr-1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
