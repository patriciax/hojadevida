<script setup>
import { ArrowDownIcon, ArrowDownLeftIcon, ArrowDownTrayIcon, Cog6ToothIcon, DocumentTextIcon } from '@heroicons/vue/24/solid'
</script>
...
<template>
  <div class="lg:hidden block fixed z-50 w-full h-16  -translate-x-1/2 bg-white rounded-t-md bottom-0 left-1/2 shadow-xl">
    <div class="grid h-full max-w-lg grid-cols-4 mx-auto">
      ...
      <button data-tooltip-target="tooltip-settings" type="button" class="text-gray-600 inline-flex flex-col items-center justify-center px-5 hover:text-blue-600  group" @click="$emit('download')">
