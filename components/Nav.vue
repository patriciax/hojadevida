      ...
      <div class="flex max-w-md m-auto flex-col lg:gap-2 gap-4 items-center justify-center rtl:space-x-reverse">
        ...
        <section class="w-full flex gap-4 items-center mb-2">
          <div class="flex items-center  ">
            <input id="default-radio-1" :checked="!resumenStore.isPassword" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 cursor-pointer  border-gray-300  ">
            <label for="default-radio-1" class="ms-2 text-sm cursor-pointer font-medium text-gray-900 "> {{ $t('addpublic') }} </label>
          </div>
          <div class="flex items-center">
            <input id="default-radio-2" :checked="resumenStore.isPassword" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600  border-gray-300 cursor-pointer  ">
