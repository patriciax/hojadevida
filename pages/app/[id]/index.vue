...
<template>
  <div class="group menu-share  fixed z-50 bottom-0 right-0 p-2  flex items-end justify-end w-24 h-24 ">
    ...
    <!-- sub left -->
    <div class="absolute cursor-pointer rounded-full transition-all duration-[0.2s] ease-out scale-y-0 group-hover:scale-y-100 group-hover:-translate-x-16   flex  p-2 hover:p-3 bg-green-300 scale-100 hover:bg-green-400 text-white" @click="shared">
      <ShareIcon class="w-5 h-5 " />
    </div>
    <!-- sub top -->
    <div class="absolute cursor-pointer rounded-full transition-all duration-[0.2s] ease-out scale-x-0 group-hover:scale-x-100 group-hover:-translate-y-16  flex  p-2 hover:p-3 bg-blue-300 hover:bg-blue-400  text-white">
      <a
    ...
    <!-- sub middle -->
    <div class="absolute cursor-pointer rounded-full transition-all duration-[0.2s] ease-out scale-x-0 group-hover:scale-x-100 group-hover:-translate-y-14 group-hover:-translate-x-14   flex  p-2 hover:p-3 bg-yellow-300 hover:bg-yellow-400 text-white" @click="downloadPdf">
